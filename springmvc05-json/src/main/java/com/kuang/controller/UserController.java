...
//    @ResponseBody//它就不会走视图解析器，回直接返回一个字符串
    ...
    public String json31() throws JsonProcessingException {
        ...
        return mapper.writeValueAsString(date + "<==>" + format); //"Sun Jan 31 10:37:57 CST 2021<==>2021-01-31 10:37:57"
//        return mapper.writeValueAsString(date+ "<==>");//1612060674484 //"Sun Jan 31 10:43:36 CST 2021<==>"
    }
